# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/00d_utils.metrics.ipynb.

# %% auto 0
__all__ = ['series_id_column_name', 'time_column_name', 'event_column_name', 'score_column_name', 'use_scoring_intervals',
           'tolerances', 'ParticipantVisibleError', 'score', 'event_detection_ap', 'find_nearest_time_idx',
           'match_detections', 'precision_recall_curve', 'average_precision_score']

# %% ../../nbs/00d_utils.metrics.ipynb 3
